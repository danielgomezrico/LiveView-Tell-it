...
public class ContactsDAO {
    ...
    public static ArrayList<Contact> getStarredContacts(Context context) {
        ...
        try {
            ...
            String[] projection = new String[]{ContactsContract.Contacts.STARRED, ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME, ContactsContract.CommonDataKinds.Phone.NUMBER, ContactsContract.CommonDataKinds.Phone.TIMES_CONTACTED};

            // Where will be the query
            Uri contactsUri = ContactsContract.CommonDataKinds.Phone.CONTENT_URI;

            Cursor cursor = resolver.query(contactsUri, projection, ContactsContract.CommonDataKinds.Phone.STARRED + "=?", new String[]{"1"}, ContactsContract.CommonDataKinds.Phone.TIMES_CONTACTED + " DESC");
